...
def ConfirmedServiceTemplateEmailNotify(receiver, subject, body, name, instance):
    try:
        ...
        html_message = render_to_string('service_confirmation_mail.html', {"name": name, "message": body, "product": instance.service.title, "amount": amount, "duration": instance.bookedDuration})
